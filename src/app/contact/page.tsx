...
import Footer from '../components/Footer'; // Sesuaikan path-nya jika diperlukan
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-700 text-center">info@weddingorganizer.com</p>
            </div>
            {/* Telepon */}
            <div className="flex flex-col items-center">
              <svg
              ...
              <p className="text-gray-700 text-center">+62 812 3456 7890</p>
            </div>
          </div>
        </div>
      </section>
